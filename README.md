...
* [Creación de una API web con ASP.NET Core - TodoApi v2.2](https://docs.microsoft.com/es-es/aspnet/core/tutorials/first-web-api?view=aspnetcore-2.2&tabs=visual-studio)
* [Creación de una API web con ASP.NET Core - TodoApi v3.0](https://docs.microsoft.com/es-es/aspnet/core/tutorials/first-web-api?view=aspnetcore-3.0&tabs=visual-studio)
